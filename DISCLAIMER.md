...
2. **Legal compliance.**
   ...
   including, but not limited to, privacy laws, wiretapping statutes, and
   child-protection regulations.

3. **No covert adult surveillance.**
   This tool must not be used to secretly monitor any person who is 18 years
   of age or older. Doing so without explicit written consent is a criminal
...
5. **Data security.**
   ...
   control**. The author has no access to your data. You are responsible for
   securing your Supabase project (API keys, Row Level Security policies,
   access controls).

6. **Transparency with the child.**
   Best practice — and the law in many regions — requires that a child is
   informed that their device is being monitored. Covert monitoring of a child
   may be restricted even for parents in some jurisdictions. Consult legal
   counsel if you are unsure.

If you are not the legal guardian of the child or do not own the device,
